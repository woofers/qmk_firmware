...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    LM(_SHIFT, MOD_LSFT),  KC_Z,    KC_X,    KC_C,       KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM,    KC_DOT, KC_SLSH, KC_UP,   KC_APP, \
    KC_LCTL,               KC_LGUI, KC_LALT, TO(_RAISE), KC_SPC,           KC_BSPC, KC_BSPC, TO(_WEB),   KC_DEL, KC_LEFT, KC_DOWN, KC_RGHT
  ),
  [_SHIFT] = LAYOUT(
