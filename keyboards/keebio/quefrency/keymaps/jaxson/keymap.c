...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,       KC_V,    KC_B,    KC_N,      KC_M,      KC_COMM,  KC_DOT, KC_SLSH, KC_UP,   KC_RGUI, \
    KC_LCTL, KC_LGUI, KC_LALT, TO(_RAISE), SPACE,            BACKSPACE, BACKSPACE, TO(_WEB), KC_APP, KC_LEFT, KC_DOWN, KC_RGHT
  ),
  [_RAISE] = LAYOUT(
  ...
  [_NUM] = LAYOUT(
    KC_ESC,  _______, _______, _______, _______, _______, _______, KC_PSLS, KC_PAST, KC_PMNS, _______, _______, _______, TO(_BASE), KC_F1, \
